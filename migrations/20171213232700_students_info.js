...
exports.up = function(knex, Promise) {
  return knex.schema.createTable("students_info", function(table){
    table.increments("id").primary();
    // insert user_id reference later table.integer("user_id").notNullable().references("id").inTable("users").onDelete("cascade").index();
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTableIfExists("students_info");
};
